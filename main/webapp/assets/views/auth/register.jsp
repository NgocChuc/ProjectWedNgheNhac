...
<link rel="stylesheet" href="${pageContext.request.contextPath}/assets/css/Login_Logout_Register.css">
</head>
<body>
<div class="login-container">
    <div class="login-card">
       ...
       <form action="${pageContext.request.contextPath}/register" method="post" class="login-form">
            ...
            <p style="text-align:center;">Already have an account? <a href="${pageContext.request.contextPath}/assets/views/auth/login.jsp">Login</a></p>
        </form>
    </div>
</div>
</body>
